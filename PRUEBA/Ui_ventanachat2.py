# Form implementation generated from reading ui file 'd:\Documentos\SUPERIOR\4toSEMESTRE\Programacion avanzada\Practicas_\PRUEBA\ventanachat2.ui'
#
...
"border-radius: 10px;")
        ...
        self.escribir_mensaje.setGeometry(QtCore.QRect(10, 330, 400, 70))
        ...
        self.enviar.setGeometry(QtCore.QRect(330, 420, 75, 24))
        self.enviar.setObjectName("enviar")
        self.zumbido = QtWidgets.QPushButton(parent=self.frame_4)
        self.zumbido.setGeometry(QtCore.QRect(380, 300, 30, 30))
        self.zumbido.setStyleSheet("background-color: rgb(236, 243, 253);")
        self.zumbido.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("d:\\Documentos\\SUPERIOR\\4toSEMESTRE\\Programacion avanzada\\Practicas_\\PRUEBA\\zumbido.jpg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 300, 400, 30))
...
"border-radius: 10px;")
        ...
        self.plainTextEdit = QtWidgets.QPlainTextEdit(parent=self.frame_4)
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 50, 400, 200))
        self.plainTextEdit.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.frame_5 = QtWidgets.QFrame(parent=self.frame_4)
        self.frame_5.setGeometry(QtCore.QRect(460, 20, 232, 443))
        ...
        self.fotoperfil1.setScaledContents(True)
        ...
        self.fotoperfil2.setScaledContents(True)
...
"")
        ...
        self.frame_3.setGeometry(QtCore.QRect(-470, -20, 698, 74))
        self.frame_3.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_3.setObjectName("frame_3")
        self.cfoto = QtWidgets.QPushButton(parent=self.frame_3)
        self.cfoto.setGeometry(QtCore.QRect(540, 40, 111, 24))
        self.cfoto.setObjectName("cfoto")
        self.label_9.raise_()
        self.label_8.raise_()
        ...
        self.nombre2.raise_()
        self.frame_3.raise_()
        self.listaamigos = QtWidgets.QComboBox(parent=self.frame_4)
        self.listaamigos.setGeometry(QtCore.QRect(308, 260, 101, 22))
        self.listaamigos.setObjectName("listaamigos")
        self.listaamigos.addItem("")
        self.listaamigos.addItem("")
        self.listaamigos.addItem("")
        self.label_7.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cfoto.setText(_translate("Dialog", "CAMBIAR FOTO"))
        self.listaamigos.setItemText(0, _translate("Dialog", "Todos"))
        self.listaamigos.setItemText(1, _translate("Dialog", "Ricardo"))
        self.listaamigos.setItemText(2, _translate("Dialog", "Tigre"))
